// ============================================================
//  cpu_multiplier : sequential shift-add multiplier
//  Produces the low 32 bits after one load cycle and 32 steps.
// ============================================================
module cpu_multiplier (
    input             clk, rst, start,
    input      [31:0] a, b,
    output     [31:0] result,
    output reg        busy,
